...
export const metadata: Metadata = {
  title: "Gallery Studio - Contemporary Art & Photography",
  description: "Discover curated contemporary art and photography exhibitions. Visit our gallery for immersive art experiences and exclusive artist collections.",
  keywords: "art gallery, contemporary art, photography, exhibitions, artists, art curation",
  metadataBase: new URL("https://gallerystudio.com"),
  alternates: {
    canonical: "https://gallerystudio.com"
  },
  openGraph: {
    title: "Gallery Studio - Contemporary Art & Photography",
    description: "Discover curated contemporary art and photography exhibitions",
    siteName: "Gallery Studio",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765986227264-nxl1vrcy.jpg",
        alt: "Gallery Studio contemporary art space"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Gallery Studio - Contemporary Art & Photography",
    description: "Curated art exhibitions and photography collections",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765986227264-nxl1vrcy.jpg"]
  },
  robots: {
    index: true,
    follow: true
